  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        'share-tech-mono': ['var(--font-share-tech-mono)', 'Courier New', 'monospace'],
        'squada-one': ['var(--font-squada-one)', 'system-ui', '-apple-system', 'sans-serif'],
      },
      backgroundImage: {
      ...
      animation: {
        ...
        'zezzz': 'zezzz 2s linear infinite',
      },
    },
  },
